...
import com.example.springsecurityoauth2clientdemo.jose.Jwks;
...
public class AuthorizationServerConfig {
	...
	public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate) {
		RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
				...
				.redirectUri("http://127.0.0.1:8080/login/oauth2/code/callback")
...
//					.setting(ConfigurationSettingNames.Token.ACCESS_TOKEN_FORMAT, OAuth2TokenFormat.REFERENCE)
	...
	public OAuth2AuthorizationService authorizationService(JdbcTemplate jdbcTemplate,
		...
		return new JdbcOAuth2AuthorizationService(jdbcTemplate, clientRepository, new DefaultLobHandler());
	}
